...
if fs.exists "AndysPrograms/farm/dev_mode" then
    ...
    gui_themes_update = {"BPplays","CC-Farm","dev","themes/catppuccin_mocha/cm.lua","cm","AndysPrograms/api/gui/themes/Catppuccin_Mocha"}
    ...
    gui_themes_update = {"BPplays","CC-Farm","main","themes/catppuccin_mocha/cm.lua","cm","AndysPrograms/api/gui/themes/Catppuccin_Mocha"}
